/**
 * @file admin.js
 * @description Client-side logic for the BRANI-360 .env Variables Editor. Handles auto-expanding inputs, variable block movement, collapsing, protecting core config elements, and saving state.
 */
